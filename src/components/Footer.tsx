...
function getUrl(platform: Platform, locId: string) {
  const locations = [
    ...
    {
      id: "frankston",
      doordashUrl: "https://www.doordash.com/en-AU/store/rizin’s-smash-burgers-frankston-42292193/104211546/?preview=1",
      uberEatsUrl: "https://www.ubereats.com/store/rizins-smash-burgers-frankston/vzuG0_aQT_KakO4DmMl1rg?utm_source=menu-maker",
    },
  ];
