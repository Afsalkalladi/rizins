...
const slides = [
  ...
  {
    image: "/images/chicken/fried.png",
    subtitle: "FRIED",
    title: "CHICKEN",
  },
  {
...
export default function Hero() {
  ...
  // Order modal state (shared hook + component)
    ...
    <>
      <section className="relative w-full h-[439px] sm:h-[500px] md:h-[560px] lg:h-[640px] xl:h-[720px] bg-brand-brown overflow-hidden">
        ...
        >
          ...
          <button
            onClick={openModal}
            className="w-[161px] h-[32px] sm:w-[180px] sm:h-[38px] md:w-[200px] md:h-[42px] lg:w-[240px] lg:h-[50px] bg-brand-red rounded-[28px] flex shrink-0 items-center justify-center hover:bg-red-700 transition-all shadow-lg hover:shadow-brand-red/40 hover:scale-105 active:scale-95"
          >
